 ...
 *
 */
@WebServlet(name = "request08", urlPatterns = "/request08")
public class Request08 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		System.out.println("Request08 doGet");
		resp.sendRedirect("/ServletBasic/request09/child");//request09 서블릿 호출 절대경로
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		System.out.println("Request08 doPost");
		resp.sendRedirect("request09/child");//request09 서블릿 호출 상대경로
	}
}
